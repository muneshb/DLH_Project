...
from data_load import PatientSimilarity, TripletPatient
...
patient_train_dataset = TripletPatient(patient_dataset, train=True)
patient_test_dataset = TripletPatient(patient_dataset, train = False)
